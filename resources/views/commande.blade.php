          ...
          <nav class="js-mega-menu navbar navbar-expand-md header-nav">
            ...
            <div id="navBar" class="collapse navbar-collapse">
              <ul class="navbar-nav ml-auto main-navbar-nav">
                ...
                @if (Auth::user())
                    <a
                        class="btn solid-white-btn animated-btn"
                        href="{{route('home')}}"
            ...
            <div class="col-md-12 col-lg-9">
              ...
              >
                @if ($message = Session::get('success'))
                    <h1 class="text-green">{{$message}} </h1>
                @else
            ...
            <div class="col-md-12 col-lg-4">
              <div class="custom-plan-info-box p-5 white-bg custom-shadow">
                ...
                <div class="btn-holder">
                  <form action="{{route('create.commande')}}" method="POST">
                      @csrf
                      <input type="text"  name="core" id="InputvpsCore" value="0" hidden>
                      <input type="text"  name="memory" id="InputvpsMemory" value="0" hidden>
                      <input type="text"  name="storage" id="InputvpsStorage" value="0" hidden>
                      <input type="text"  name="bandwidth" id="InputvpsBandwidth" value="0" hidden>
                      <input type="text"  name="price" id="InputvpsPrice" value="0" hidden>
                      <button type="submit" class="btn primary-solid-btn vpsWHmcsUrl"
                    >Order now</button
                  >
                  </form>
                </div>
