...
jQuery(function ($) {
  ...
  function setVpsValue(vpsObj) {
    ...
    $('#InputvpsCore').val(vpsObj.vpsCore) ;
    $('#InputvpsMemory').val(vpsObj.vpsMemory) ;
    $('#InputvpsStorage').val(vpsObj.vpsStorage) ;
    $('#InputvpsBandwidth').val(vpsObj.vpsBandwidth) ;
    $('#InputvpsPrice').val(vpsObj.vpsPrice) ;
