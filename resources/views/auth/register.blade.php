                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="card login-signup-card shadow-lg mb-0">
                            <div class="card-body px-md-5 py-5">
                                <div class="mb-5">
                                    <h5 class="h3">Creation de compte</h5>
                                ...
                                @enderror
                                    ...
                                    <div class="my-4">
                                        <div class="custom-control custom-checkbox mb-3">
                                            ...
                                            <label class="custom-control-label" for="check-terms">J'accepte les <a href="terms-condition.html">termes et conditions</a></label>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer px-md-5 bg-transparent border-top"><small>Déja un compte?</small>
